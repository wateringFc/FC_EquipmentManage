...
class FC_PickerView: UIView {
    ...
    fileprivate lazy var butBgView: UIView = {
        ...
        butBgView.backgroundColor = HexColor(0xEEEEEF)
        return butBgView
    }()
    ...
    fileprivate lazy var cancelButton: UIButton = {
        ...
        cancelButton.setTitleColor(Theme_4B77F6_Blue, for: UIControlState.normal)
    ...
    fileprivate lazy var doneButton: UIButton = {
        ...
        doneButton.setTitleColor(Theme_4B77F6_Blue, for: UIControlState.normal)
