...
extension FCPieView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if middleText!.count > 1 {
            ...
            middleLb.textColor = Main_222222_Color
            addSubview(middleLb)
    ...
    private func createLabel(text: String, endPoint:CGPoint, isUpText:Bool) -> (UILabel) {
        ...
        if isUpText {
            ...
            lalel.textColor = bottomTextColor
            lalel.font = UIFont.systemFont(ofSize: 11)
            // 线下
            lalel.snp.makeConstraints { (make) in
                make.height.equalTo(15)
